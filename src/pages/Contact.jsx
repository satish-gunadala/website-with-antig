            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-gray-200">
                    <form className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    id="subject"
                                    className="w-full pl-10 px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all"
                        ...
                        <button
                            type="submit"
                            className="w-full bg-primary text-white font-bold py-4 rounded-lg hover:bg-sky-600 transition-colors flex items-center justify-center gap-2"
                        >
